...
var $ = {
    ...
    klass: function(className, parent, noExtract){
        ...
        return noExtract || result.length > 1 ? Array.prototype.slice.call(result) : result[0];
    },
    ...
    tag: function(tagName, parent){
        return Array.prototype.slice.call((parent || document).getElementsByTagName(tagName));
    },
